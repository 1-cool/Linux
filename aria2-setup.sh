...
#
# https://gh-proxy.org/https://github.com/P3TERX/aria2.sh
...
Crontab_file="$PREFIX/bin/crontab"
...
Update_bt_tracker() {
    ...
    check_pid
    [[ -z $PID ]] && {
        bash <(wget -qO- "https://gh-proxy.org/https://github.com/P3TERX/aria2.conf/raw/refs/heads/master/tracker.sh") ${aria2_conf}
    } || {
        bash <(wget -qO- "https://gh-proxy.org/https://github.com/P3TERX/aria2.conf/raw/refs/heads/master/tracker.sh") ${aria2_conf} RPC
    }
}
Update_aria2() {
    check_installed_status
...
Update_Shell() {
    sh_new_ver=$(wget -qO- -t1 -T3 "https://gh-proxy.org/https://github.com/P3TERX/aria2.sh/raw/refs/heads/master/aria2.sh" | grep 'sh_ver="' | awk -F "=" '{print $NF}' | sed 's/\"//g' | head -1) && sh_new_type="github"
    ...
    wget -N "https://gh-proxy.org/https://github.com/P3TERX/aria2.sh/raw/refs/heads/master/aria2.sh" && chmod +x aria2.sh
