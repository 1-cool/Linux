...
curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/1-cool/Linux/refs/heads/master/ssh-safe.sh | bash

# 安装zsh和oh-my-zsh
#curl -fsSL https://raw.githubusercontent.com/1-cool/Linux/refs/heads/master/install-zsh.sh | bash
curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/1-cool/Linux/refs/heads/master/install-zsh.sh | bash

# 安装和配置fail2ban
#curl -fsSL https://raw.githubusercontent.com/1-cool/Linux/refs/heads/master/fail2ban.sh | bash
curl -fsSL https://gh-proxy.org/https://raw.githubusercontent.com/1-cool/Linux/refs/heads/master/fail2ban.sh | bash
